...
public:
	Floor(const int, const char* const, const char* const); // elevation (inchesabove ground) of floor, name and label
	...
	int getNumberOfDownRiders() const { return downRiders.size(); }// for external reporting
