...
void addSong(Playlist& playlist) {
    string newsong;
    string folderPath = "C:\\Users\\Magic\\source\\repos\\DSFinal\\x64\\Debug\\music";
    ...
    int choice;
    string menu = "1- Add at the Start of the Queue, 2- Add at the end of the Queue, 3- Add Song after another one, 4- Back: ";
    cout << menu;
    cin >> choice;
    ...
    if (playlist.currentlyPlaying != nullptr) {
        cout << "Adding to the queue: " << fullPath << endl;
        addSongtoBack(playlist, fullPath);
    }
